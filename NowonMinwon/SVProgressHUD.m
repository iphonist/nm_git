...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.maskType) {
        ...
        case SVProgressHUDMaskTypeBlack: {
            [[UIColor colorWithWhite:0 alpha:0.33] set];
...
- (UIImage *)hudSuccessImage {
    ...
    return [CustomUIKit customImageNamed:@"SVProgressHUD.bundle/success.png"];
}
...
- (UIImage *)hudErrorImage {
    ...
    return [CustomUIKit customImageNamed:@"SVProgressHUD.bundle/error.png"];
}
